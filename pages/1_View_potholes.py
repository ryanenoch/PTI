...
if os.path.isfile('potholes.csv') == True:
  ...
  cols = ['street', 'timestamp',
          'image']  #select columns other than lat and long
  ...
  #setting up icons & color for potholes
  ...
  plugins.LocateControl(auto_start=False,
                        ...
                        strings={
                          ...
                          "popup":
                          "You're within {distance} {unit} from this point"
                        }).add_to(m)
